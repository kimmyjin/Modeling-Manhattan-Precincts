...
samp1<-Csamp(300,0.0065,c(-73.9748436,40.76957945))
samp2<-Csamp(300,0.0062,c(-73.9701388,40.77604835))
samp3<-Csamp(300,0.0061,c(-73.9654345,40.78251725))
samp4<-Csamp(300,0.0061,c(-73.9607292,40.78898615))
samp5<-Csamp(300,0.0062,c(-73.9560239,40.79545503))

sample_together <-data.frame(rbind(samp1,samp2,samp3,samp4,samp5, neg1, neg2, pos1, pos2))
df <- data.frame(address = rep("Central Park",1900),precinct = 22,sample_together)
